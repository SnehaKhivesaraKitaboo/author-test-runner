...
const HTML = path.join(ROOT, 'docs', 'team-demo-summary.html');
const PDF = path.join(ROOT, 'docs', 'Kitaboo-Authoring-Tests-Team-Demo-Summary.pdf');
    ...
    await page.pdf({
      ...
      footerTemplate: `
        <div style="width:100%;font-size:8px;color:#64748b;padding:0 12mm;text-align:center;font-family:sans-serif;">
          Kitaboo Authoring Tests — Team Demo Summary &nbsp;|&nbsp; Page <span class="pageNumber"></span> of <span class="totalPages"></span>
        </div>`,
    });
