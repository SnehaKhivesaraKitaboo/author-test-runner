...
// =============================================================================
// 20 — Right Layout (layout-3) — Deep Component Test
//
...
//   templates/layouts/layout3.html (2 columns: two-thirds + one-third)
...
//
// Right is a LAYOUT (Layout section), not an assessment widget: it drops onto
// the Instructions-for-Students canvas (#desktop_view) via
// cy.dropComponent('Right'). Automated cases cover drop, column
...
// and CLP are deferred. See RIGHT-LAYOUT-DEEP-AUTOMATION.md.
// =============================================================================
...
beforeEach(function () {
  ...
  cy.ensureRightLayoutDeepSetup({ through: 'dropped', skipCanvasNav: true });
});

// ===========================================================================
// Suite A — Drop onto canvas (TC_11, TC_12)
// ===========================================================================
describe('20-A — Right Layout: Drop onto canvas (TC_11, TC_12)', () => {
  it('TC_DROP — Drop Right layout onto the Instructions canvas', function () {
    skipIfNoUrl(this);
    cy.ensureRightLayoutDeepSetup({ through: 'dropped', skipCanvasNav: false });
    cy.get(`#desktop_view .sd-item ${LAYOUT_CANVAS.widget}`, { timeout: 20000 }).should('exist');
    cy.log('✅ Right layout dropped onto canvas');
  });
  ...
  it('TC_11/TC_12 — Layout is draggable and placed successfully in the step canvas', function () {
    ...
    cy.log('✅ TC_11/12: Right layout is draggable and placed on the active step page');
  });
});
...
// ===========================================================================
describe('20-B — Right Layout: Column structure (TC_27, TC_28, TC_57)', () => {
  ...
  it('TC_27b — Column widths match source (two-thirds + one-third)', function () {
    skipIfNoUrl(this);
    cy.get(LAYOUT_CANVAS.columnWide).should('exist');
    cy.get(LAYOUT_CANVAS.columnNarrow).should('exist');
    cy.log('✅ TC_27b: layout-3 leads with the wide (two-thirds) column then narrow (one-third) (source-verified)');
  });
...
// ===========================================================================
describe('20-C — Right Layout: Child drop zones (TC_13, TC_14, TC_19–TC_22)', () => {
...
// ===========================================================================
describe('20-D — Right Layout: Settings panel (TC_31)', () => {
  beforeEach(function () { skipIfNoUrl(this); cy.openRightLayoutSettings(); });
...
// ===========================================================================
describe('20-E — Right Layout: Divider & outline (TC_53, TC_54)', () => {
...
// ===========================================================================
describe('20-F — Right Layout: Delete (TC_25, TC_59)', () => {
...
// Suite G — Security
// ===========================================================================
describe('20-G — Right Layout: Security', () => {
...
// ===========================================================================
describe('20-Z — Right Layout: Deferred (Bootstrap / nesting rules / Preview / Reader / Publish / lifecycle)', () => {
